...
<!-- Generated by scripts/generate-notifications-docs.mjs on 2026-03-09 10:52:55 UTC -->
...
| `workspace.invite_sent` | Invite | workspace | ✅ | ✅ | ✅ | ❌ | ✅ | `/w/:workspaceId/settings/members | /w/:workspaceId/clients` |
| `workspace.member_joined` | Member Joined | workspace | ✅ | ✅ | ✅ | ❌ | ✅ | `/w/:workspaceId/settings/members | /w/:workspaceId/clients` |
| `workspace.member_removed` | Member Removed | workspace | ✅ | ✅ | ✅ | ❌ | ✅ | `/w/:workspaceId/settings/members | /w/:workspaceId/clients` |
...
**Levon** added "Brand Guidelines v2" to the Asset Library

**Delivery:** Inbox only
**Route:** `/w/:workspaceId/assets/:assetId`
...
**Delivery:** Sonner toast + Browser notification (if tab hidden)
**Route:** `/w/:workspaceId/settings/members | /w/:workspaceId/clients`
...
_Generated by `scripts/generate-notifications-docs.mjs` · 2026-03-09 10:52:55 UTC_
