...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Create a Supabase client and verify the user JWT explicitly.
    // Pass the token directly to getUser() — the correct server-side pattern
    // in Supabase JS v2 (relying on global headers alone is unreliable in Deno).
