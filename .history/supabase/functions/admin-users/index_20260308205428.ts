...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // The user sends their JWT in the Authorization header.
    ...
    // Create a Supabase client with the user's auth header forwarded,
    // then call getUser() so Supabase validates the JWT server-side.
