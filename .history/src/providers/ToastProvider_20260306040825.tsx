          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <div className="min-w-0">
                  <p className="truncate text-2xl font-semibold leading-8 text-foreground">
                    Notification
                  </p>
                  <p className="mt-1 text-lg leading-7 text-muted">{toast.message}</p>
                </div>
              </div>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <Button
                ...
                variant="default"
                size="sm"
                className="h-11 rounded-xl px-6 text-lg font-medium"
                onClick={() => {
                  toast.onUndo?.();
              ...
              <Button
                ...
                variant="secondary"
                size="sm"
                className="h-11 rounded-xl border-border/70 bg-surface/70 px-5 text-lg font-medium text-foreground hover:bg-surface"
                onClick={() => dismissToast(toast.id)}
              >
                Close notification
              </Button>
