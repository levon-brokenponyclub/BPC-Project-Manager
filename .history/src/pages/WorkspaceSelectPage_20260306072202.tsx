    ...
    <div className="dark min-h-screen bg-[#15161D] px-4 py-10 text-white md:py-16">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-[#939496]">
        ...
        <div className="grid gap-4">
          ...
          {(workspacesQuery.data ?? []).map((workspace) => (
            <Link key={workspace.id} to={`/w/${workspace.id}/dashboard`}>
              <Card className="flex items-center justify-between px-5 py-5 transition-all bg-[#191A22] border border-[#292B38] hover:bg-[#1F2028]">
                <div>
          ...
          (workspacesQuery.data ?? []).length === 0 ? (
            <Card className="px-5 py-8 text-sm text-[#939496] bg-[#191A22] border border-[#292B38]">
