...
export function LoginPage(): React.ReactElement {
  ...
  return (
    <div className="flex min-h-screen items-start justify-center bg-background px-4 pb-8 pt-8 text-foreground md:pt-[68px]">
      <Card className="w-full max-w-[520px] rounded-[4px] border border-border bg-card p-0 shadow-card">
        <div className="mx-auto w-full max-w-[440px] px-5 pb-10 pt-11 md:px-0">
          <div className="flex items-center gap-3 border-b border-border pb-6">
            ...
            />
            <div>
              <p className="text-2xl font-medium leading-8 tracking-[-0.16px] text-foreground">
