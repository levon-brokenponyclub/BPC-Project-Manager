      ...
      <Card className="w-full max-w-[520px] rounded-[4px] border border-[#292B38] bg-[#191A22] p-0 shadow-none">
        <div className="mx-auto w-full max-w-[440px] px-5 pb-10 pt-11 md:px-0">
          ...
          >
            ...
            <div className="pt-2">
              <Button
                className="w-full h-10 rounded-[3px] border border-[#6C77E5] bg-[#5E69D1] px-[14px] py-[8px] text-[13px] font-semibold leading-4 text-[#FEFEFF] shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] hover:bg-[#6A76EB]"
                type="submit"
