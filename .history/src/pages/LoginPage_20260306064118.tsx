...
export function LoginPage(): React.ReactElement {
  ...
  return (
    <div className="flex min-h-screen items-start justify-center bg-[#15161D] px-4 pb-8 pt-8 md:pt-[68px]">
      <Card className="w-full max-w-[611px] rounded-[4px] border border-[#25262B] bg-[#0F1011] p-0 shadow-none">
        ...
        {/* <div className="mt-4 rounded-xl border border-border p-3">
          ...
          {!isSupabaseConfigured ? (
            <div className="mt-6 rounded-md border border-amber-400/40 bg-amber-950/30 px-3 py-2 text-xs text-amber-200">
          ...
          {isDemoMode ? (
            <Button
              className="mt-4 h-8 w-full rounded-[5px] border border-[#D8D8D8] bg-white px-[14.5px] py-[8.25px] text-[13px] font-medium leading-4 text-[#303031] shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.02),0px_1px_1px_rgba(0,0,0,0.06)] hover:bg-[#F5F5F6]"
              type="button"
              onClick={async () => {
                setError("");
        ...
        >
            <div className="space-y-1">
              <p className="text-[13px] font-medium leading-4 text-white">Email</p>
              <Input
                type="email"
                required
                ...
                className="h-10 rounded-[5px] border border-[#25262B] bg-[#15161D] px-3 text-[13px] text-white placeholder:text-[#939496]"
              />
            </div>
            ...
            {!isDemoMode ? (
              <>
                <div className="space-y-1">
                  <p className="text-[13px] font-medium leading-4 text-white">Password</p>
                  <Input
                    type="password"
                    required
            ...
            {!isDemoMode ? (
              <Button
                className="mx-auto h-8 w-full max-w-[386px] rounded-[5px] border border-[#25262B] bg-[#15161D] px-[14.5px] py-[8.25px] text-[13px] font-medium leading-4 text-[#D4D5D8] shadow-none hover:bg-[#1A1B23]"
                type="button"
                onClick={() => {
                  setError("");
                  setMessage("");
