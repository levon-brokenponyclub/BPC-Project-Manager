...
import { getWorkspaceSupportSummary } from '@/api/time'
  ...
  return (
    <div className="space-y-4">
      <Card className="p-5">
        ...
        <p className="mt-1 text-sm text-muted">Prepaid retainer usage for this period.</p>
      ...
      <Card className="p-5">
        ...
        <div className="mt-3 space-y-2">
          {(recentTasksQuery.data ?? []).slice(0, 8).map((task) => (
            <div key={task.id} className="flex items-center justify-between rounded-xl bg-stone-50 px-3 py-2">
