...
import { getAllSystemUsers, filterClientUsers, type SystemUser } from "@/api/clients";
...
export function ClientsPage(): React.ReactElement {
  ...
  // Filter to only show client users (exclude admins)
  ...
  const isEmpty = !isLoading && !isError && clientUsers.length === 0;
