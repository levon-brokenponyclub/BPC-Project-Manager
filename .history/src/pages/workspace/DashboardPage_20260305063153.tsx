  ...
  const commentMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      await notifyWorkspaceEvent(workspaceId, "comment.created", {
        ...
        commentPreview: body.slice(0, 80),
      });
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium focus-ring disabled:pointer-events-none disabled:opacity-50 bg-primary text-white shadow-card hover:shadow-lift hover:-translate-y-[1px] transition-all h-10 px-4 py-2"
          >
            Top Up
          </button>
        </div>
