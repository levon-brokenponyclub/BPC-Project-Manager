...
export function ClientsPage(): React.ReactElement {
  ...
  const { adminUsers, groupedClients } = useMemo(() => {
    ...
    return {
      adminUsers: admins,
      groupedClients: Object.values(groups).sort((a, b) =>
    ...
    <div className="relative space-y-6">
      ...
      >
        <Card className="relative overflow-visible border-[#222330] bg-[#191A22]">
          ...
          <table className="w-full text-left text-sm">
            <tbody>
              {/* Admin Users Section - Not Grouped by Workspace */}
              {adminUsers.length > 0 && (
                <>
              ...
              {/* Client Users Section - Grouped by Workspace */}
