            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                <button
                  ...
                  className="focus-ring inline-flex items-center gap-1.5 rounded-md border border-border/70 bg-card/40 px-2.5 py-2 text-sm font-medium text-foreground transition-colors hover:bg-card/70"
                >
                  <svg
                    viewBox="0 0 16 16"
                    className="h-4 w-4 text-muted"
