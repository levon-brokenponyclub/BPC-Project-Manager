...
export function DashboardPage(): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      <Card className="p-5">
        <h1 className="text-xl md:text-2xl font-semibold tracking-tight text-foreground">Support Hours</h1>
      ...
      <Card className="p-5">
        ...
        <div className="mt-4 space-y-2">
          ...
          {(recentTasksQuery.data ?? []).length === 0 && (
            <p className="text-center text-sm text-muted py-8">No tasks found.</p>
          )}
        </div>
      </Card>
    </div>
