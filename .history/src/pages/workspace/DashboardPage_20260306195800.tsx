            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                <button
                  ...
                  className="focus-ring inline-flex h-9 items-center gap-1.5 rounded-sm border border-[#313339] bg-[#15161D] px-3 text-white transition-colors hover:bg-[#1C1E26] active:bg-[#20222B] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <svg
                    viewBox="0 0 16 16"
                    className="h-4 w-4 text-muted"
