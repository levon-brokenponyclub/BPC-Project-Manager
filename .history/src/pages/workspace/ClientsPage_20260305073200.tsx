...
export function ClientsPage(): React.ReactElement {
  ...
  async function handleAvatarUpload(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const fileName = `${editingUser.id}-${Date.now()}.${extension}`;
          ...
          <div className="w-full max-w-lg rounded-xl border border-border bg-card p-6 shadow-xl">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <img
                    src={editAvatarUrl || fallbackAvatarFromEmail(editEmail || editingUser.email)}
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <Button
                  disabled={
                    updateProfileMutation.isPending || isUploadingAvatar || !editEmail.trim()
                  }
                  onClick={() => {
