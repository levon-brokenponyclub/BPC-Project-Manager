          ...
          <div className="bg-card border border-border rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={hoursNum <= 0}
                className="w-full mt-4 px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Request Support
              </button>
            </div>
