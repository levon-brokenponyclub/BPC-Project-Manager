...
export function TimePage(): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      <Card className="p-5">
        <h1 className="text-xl md:text-2xl font-semibold tracking-tight text-foreground">Time Tracking</h1>
      ...
      <Card className="p-5">
        <h2 className="text-base font-semibold text-foreground">Time Entries</h2>
        <div className="mt-4 space-y-2 text-sm">
          ...
          {(entriesQuery.data ?? []).length === 0 && (
            <p className="text-center text-sm text-muted py-8">No time entries yet.</p>
          )}
        </div>
      </Card>
    </div>
