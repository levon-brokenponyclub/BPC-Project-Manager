...
export function TasksPage(): React.ReactElement {
  ...
  const tasks = [...filteredTasks].sort((a, b) => {
    ...
    if (sortBy === "status") {
      const statusOrder = { "Todo": 0, "In Progress": 1, "In Review": 2, "Complete": 3, "Cancelled": 4 };
      ...
      comparison = (priorityOrder[aPriority as keyof typeof priorityOrder] ?? 0) - (priorityOrder[bPriority as keyof typeof priorityOrder] ?? 0);
    }
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <button
                        ...
                        onClick={() => {
                          setSortBy("assignee");
                          setSortOrder(sortBy === "assignee" && sortOrder === "asc" ? "desc" : "asc");
                          setSortOpen(false);
                        }}
                        className={`focus-ring flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm transition-colors hover:bg-surface/60 ${
                          sortBy === "assignee"
                      ...
                      <button
                        ...
                        onClick={() => {
                          setSortBy("due_date");
                          setSortOrder(sortBy === "due_date" && sortOrder === "asc" ? "desc" : "asc");
                          setSortOpen(false);
                        }}
                        className={`focus-ring flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm transition-colors hover:bg-surface/60 ${
                          sortBy === "due_date"
