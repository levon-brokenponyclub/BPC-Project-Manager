...
export function ClientsPage(): React.ReactElement {
  ...
  const inviteMutation = useMutation({
    mutationFn: async () => {
      ...
      if (inviteRole !== "admin" && !inviteWorkspaceId) {
            ...
            >
              ...
              {inviteRole === "admin" ? (
                <p className="rounded-lg border border-border bg-surface px-3 py-2.5 text-sm text-muted">
                  Admin will have access to all workspaces automatically.
                </p>
              ) : (
                <div>
                  <label className="mb-1 block text-xs font-semibold uppercase tracking-wide text-muted">
                  ...
                  <p className="mt-1 text-xs text-muted">
                    User will be assigned to the selected workspace as client
                  </p>
                </div>
              )}
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <Button
                      ...
                      disabled={
                        ...
                        !inviteEmail.trim() ||
                        (inviteRole !== "admin" && !inviteWorkspaceId)
                      }
                    >
                      {inviteMutation.isPending
                        ? "Processing..."
