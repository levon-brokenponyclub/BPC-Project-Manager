      ...
      <Card className="w-full max-w-[520px] rounded-[4px] border border-[#292B38] bg-[#191A22] p-0 shadow-none">
        <div className="mx-auto w-full max-w-[440px] px-5 pb-10 pt-11 md:px-0">
          ...
          >
            ...
            <div className="pt-2">
              <Button
                className="w-full h-9 rounded-[3px] border border-[#6C77E5] bg-[#5E69D1] px-[14px] py-[8px] text-[13px] font-semibold leading-4 text-[#FEFEFF]  hover:bg-[#6A76EB]"
                type="submit"
            ...
            {!isDemoMode ? (
              <Button
                className="w-full h-8 rounded-[5px] border border-[#25262B] bg-transparent px-[14px] py-[8px] text-[13px] font-medium leading-4 text-[#D4D5D8] hover:bg-[#1A1B23] hover:text-white"
                type="button"
                onClick={() => {
                  setError("");
                  setMessage("");
