        ...
        {navItems.map(({ key, label, Icon }) => {
          ...
          return (
            <div key={key} className="relative group">
              ...
              <span className="pointer-events-none absolute right-full top-1/2 mr-3 -translate-y-1/2 whitespace-nowrap rounded-xl bg-slate-900/90 px-3 py-2 text-xs font-medium text-white shadow-md opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">
                {label}
