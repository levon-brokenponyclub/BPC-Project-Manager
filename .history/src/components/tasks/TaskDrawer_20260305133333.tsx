        ...
        {navItems.map(({ key, label, Icon }) => {
          ...
          return (
            <div key={key} className="relative group">
              ...
              {/* Callout label: hover for all items */}
              <span className="pointer-events-none absolute right-full top-1/2 mr-3 -translate-y-1/2 whitespace-nowrap rounded-xl bg-slate-900/90 px-3 py-2 text-xs font-medium text-white shadow-md transition-opacity opacity-0 group-hover:opacity-100 group-focus-within:opacity-100">
                {label}
            ...
            <div className="min-w-0 flex-1 overflow-y-auto px-6 pb-6 pr-4">
              ...
              {!isNewTask && activeTab === "activity" ? (
                <div className="flex min-h-0 flex-1 flex-col">
                  <h2 className="py-4 text-3xl font-semibold leading-tight tracking-tight text-foreground">
                    Activity
                  </h2>
