                            ...
                            <div className="relative flex justify-center">
                              ...
                              {entry.type === "comment" ? (
                                <img
                                  ...
                                  alt={entry.actorName}
                                  className="relative z-10 mt-0.5 h-7 w-7 rounded-full border border-[#15161D] bg-card object-cover"
                                  loading="lazy"
                                />
                              ) : (
                                <span className="relative z-10 mt-2 h-2.5 w-2.5 rounded-full border border-[#15161D] bg-[#15161D]" />
                              )}
                            </div>

                            {entry.type === "comment" ? (
                              <div className="rounded-2xl border border-[#15161D] bg-card px-4 py-3">
