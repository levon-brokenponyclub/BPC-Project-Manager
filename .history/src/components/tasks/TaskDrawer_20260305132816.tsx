...
export function TaskDrawer({
  ...
  const NavPill = !isNewTask ? (
    <nav
      ...
      className="sticky top-28 w-16 rounded-2xl border border-border/60 bg-white/70 p-2 backdrop-blur-sm"
    >
            ...
            <div className="min-w-0 flex-1 overflow-y-auto px-6 pb-6 pr-4">
              ...
              {!isNewTask && activeTab === "activity" ? (
                <div className="flex min-h-0 flex-1 flex-col">
                  <h2 className="py-4 text-4xl font-semibold leading-tight tracking-tight text-foreground">
                    Activity
                  </h2>
                  ...
                  <div className="min-h-0 flex-1 space-y-4 overflow-y-auto pr-2">
                    ...
                    <div className="space-y-2">
                      {activity.map((entry) => (
                        <div
                          key={entry.id}
                          className="flex items-center justify-between gap-4 border-b border-border/40 pb-2 text-xs"
                        >
