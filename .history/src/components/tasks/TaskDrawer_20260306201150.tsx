        ...
        <div className="flex min-h-0 flex-col bg-[#1E1F2A] md:border-r md:border-[#222330]">
          <div className="flex items-center justify-between border-b border-[#222330] px-4 py-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="focus-ring inline-flex  w-8 items-center justify-center rounded-[5px] border border-[#313339] bg-[#15161D] text-[#939496] transition-colors hover:bg-[#1A1C23] hover:text-white"
