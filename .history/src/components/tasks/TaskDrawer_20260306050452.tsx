...
export function TaskDrawer({
  ...
  const drawerPrimaryCompactButtonClass =
    "h-[23px] rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] px-2 text-[12px] font-medium leading-[15px] text-[#FEFEFF] shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] hover:bg-[#6A76EB]";
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 top-14 z-40 !mt-0 bg-black/20 backdrop-blur-sm">
      <aside className="fixed bottom-0 right-0 top-14 flex h-auto w-full max-w-xl flex-col border-l border-border/60 bg-card shadow-lift animate-in slide-in-from-right">
