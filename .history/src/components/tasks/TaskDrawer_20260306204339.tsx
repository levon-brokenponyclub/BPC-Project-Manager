              ...
              <div className="space-y-6">
                <section className="space-y-4">
                  <Textarea
                    ...
                    rows={2}
                    className="min-h-[72px] resize-none border-0 bg-transparent px-0 textxl font-medium leading-8 tracking-[-0.16px] text-white shadow-none focus-visible:ring-0"
                  />
