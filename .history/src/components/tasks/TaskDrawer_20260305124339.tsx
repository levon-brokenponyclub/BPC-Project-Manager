    ...
    <div className="fixed inset-0 z-40 flex justify-end bg-black/20 backdrop-blur-sm">
      <aside className="relative h-full w-full max-w-xl overflow-y-auto border-l border-border bg-card px-6 py-6 shadow-lift animate-in slide-in-from-right">
        ...
        <div className="space-y-6">
          ...
          {!isNewTask ? (
            <section className="rounded-xl border border-border bg-stone-50/30 p-5">
              <div className="flex items-start gap-4">
                ...
                <nav
                  ...
                  className="sticky top-1/2 z-10 flex w-14 shrink-0 -translate-y-1/2 flex-col gap-3 self-start rounded-2xl border border-border/60 bg-stone-50/40 p-2 shadow-md backdrop-blur-sm"
                >
                  <div className="relative group">
                    ...
                    <span className="pointer-events-none absolute right-full mr-3 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-xl bg-slate-900/90 px-3 py-2 text-xs font-medium text-white opacity-0 shadow-md transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">
                      Task
