...
export function TaskDrawer({
  ...
  const NavPill = !isNewTask ? (
    <nav
      ...
      className="sticky top-28 h-full w-16 rounded-2xl border-l border-border bg-white/70 p-2 backdrop-blur-sm"
    >
      ...
      <aside className="fixed inset-y-0 right-0 flex h-full w-full max-w-xl flex-col border-l border-border bg-card shadow-lift animate-in slide-in-from-right">
        ...
        <div className="flex min-h-0 flex-1">
          ...
          <div className="flex min-w-0 flex-1">
            ...
            {!isNewTask ? (
              <div className="flex h-full w-[88px] shrink-0 flex-col px-3 pt-6">{NavPill}</div>
            ) : null}
          </div>
        </div>
      </aside>
