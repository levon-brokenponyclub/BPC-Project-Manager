...
export function TaskDrawer({
  ...
  const drawerActionButtonClass =
    "h-10 inline-flex items-center gap-1.5 rounded-[5px] border border-[#313339] bg-[#15161D] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#1A1C23]";
  const drawerPrimaryCompactButtonClass =
    "h-[23px] rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] px-2 text-[12px] font-medium leading-[15px] text-white hover:bg-[#6A76EB]";
      ...
      <div className="grid h-full min-h-0 grid-cols-1 md:grid-cols-[300px_minmax(0,1fr)_280px]">
        <div className="flex min-h-0 flex-col bg-[#1E1F2A] md:border-r md:border-[#222330]">
          <div className="flex items-center justify-between border-b border-[#222330] px-4 py-3">
            <h3 className="text-[18px] leading-[22px] font-medium text-white">Task Panel</h3>
            <button
              type="button"
              onClick={onClose}
        ...
        <div className="flex min-h-0 flex-col bg-[#1A1B25] md:border-r md:border-[#222330]">
          <header className="flex items-center justify-between gap-3 border-b border-[#222330] px-5 py-3">
            <h3 className="truncate text-[18px] leading-[22px] font-medium text-white">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5">
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-5 rounded-[4px] border border-[#292B38] bg-[#191A22] p-5">
                    ...
                    <div className="space-y-2">
                      <p className="text-[13px] font-medium text-[#97989E]">Due date</p>
                      <Input
                        type="date"
                        value={draftDueDate}
                        onChange={(event) =>
            ...
            {!isNewTask && activeTab === "task" ? (
              <div className="flex flex-col space-y-8">
                ...
                <section className="space-y-5 rounded-[4px] border border-[#292B38] bg-[#191A22] p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <p className="text-[13px] font-medium text-[#97989E]">Owner</p>
            ...
            {!isNewTask && activeTab === "activity" ? (
              <div className="flex min-h-0 flex-1 flex-col">
                <h2 className="py-6 text-2xl font-medium leading-8 tracking-[-0.16px] text-white">
                  Activity
                </h2>
                ...
                <div className="sticky bottom-0 border-t border-[#222330] bg-[#1A1B25] px-5 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      ...
                      className="h-10 w-10 rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] text-white hover:bg-[#6A76EB]"
                    >
        ...
        <div className="hidden min-h-0 bg-sidebar md:flex md:flex-col">
          <div className="border-b border-[#222330] px-5 py-3">
            <h3 className="text-[18px] leading-[22px] font-medium text-white">Properties</h3>
          </div>
