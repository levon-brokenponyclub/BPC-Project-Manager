...
type TaskDrawerTab = "task" | "activity" | "files";
...
export function TaskDrawer({
  ...
  const drawerActionButtonClass =
    "h-8 inline-flex items-center gap-1.5 rounded-md border border-border/70 bg-card/40 px-2.5 py-1 text-sm font-medium text-foreground shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] transition-colors hover:bg-card/70";
  const drawerFieldControlClass =
    "h-8 w-full rounded-md border border-border/70 bg-card/40 px-2.5 text-sm text-foreground focus-ring";
  const drawerReadOnlyFieldClass =
    "flex h-8 items-center rounded-md border border-border/70 bg-card/30 px-2.5 text-sm text-muted";

  const NavPill = !isNewTask ? (
    <nav
      aria-label="Task drawer navigation"
      className="sticky top-28 w-16 backdrop-blur-sm"
    >
          ...
          return (
            <div key={key} className="relative group">
              <button
                ...
                aria-label={label}
                className={`flex h-11 w-11 items-center justify-center rounded-xl transition-all focus-ring ${
                  isActive
              ...
              {/* Callout label: show on hover only */}
              <span className="pointer-events-none absolute right-full top-1/2 mr-3 -translate-y-1/2 whitespace-nowrap rounded-xl bg-slate-900/90 px-3 py-2 text-xs font-medium text-white shadow-md transition-opacity duration-200 invisible group-hover:visible">
                {label}
  ...
  return (
    <div className="fixed inset-0 z-40 !mt-0 bg-black/20 backdrop-blur-sm">
      <aside className="fixed inset-y-0 right-0 flex h-full w-full max-w-xl flex-col border-l border-border/60 bg-card shadow-lift animate-in slide-in-from-right">
        ...
        <div className="flex min-h-0 flex-1">
          <div className="flex min-w-0 flex-1">
            <div className="min-w-0 flex-1 overflow-y-auto px-4 py-4">
              {isNewTask ? (
                <div className="space-y-6">
                  <section className="space-y-4">
                    ...
                    <div className="space-y-4 rounded-md border border-border/60 bg-surface/40 p-4">
                      <h3 className="text-xs font-semibold uppercase tracking-wide text-muted">
                        Fields
                      </h3>

                      <div className="overflow-hidden rounded-md border border-border/60 bg-card/40">
                        <div className="grid grid-cols-[140px_1fr] border-b border-border/60">
                          <div className="px-3 py-2.5 text-sm font-medium text-muted">
                            Status
                          </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <Textarea
                          ...
                          className="rounded-md border-border/70 bg-card/40 px-2.5 py-2 text-sm"
                        />
                      </div>
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        className="h-[23px] rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] px-2 text-[12px] font-medium leading-[15px] text-[#FEFEFF] shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] hover:bg-[#6A76EB]"
                        onClick={async () => {
                          try {
                            await onCreateTask(
                              {
              ...
              {!isNewTask && activeTab === "task" ? (
                <div className="flex flex-col gap-6">
                  <section className="space-y-4">
                    ...
                    <div className="space-y-3 rounded-md border border-border/60 bg-surface/40 p-4">
                  ...
                  <section className="space-y-4 rounded-md border border-border/60 bg-surface/40 p-4">
                    <h3 className="text-xs font-semibold uppercase tracking-wide text-muted">
                      Fields
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <label className="flex items-center gap-2 rounded-md border border-border/60 bg-card/30 px-3 py-2">
                        <input
                          type="checkbox"
                          className="h-4 w-4"
                    ...
                    <label className="flex items-center gap-2 rounded-md border border-border/60 bg-card/30 px-3 py-2 text-sm">
                      <input
                        type="checkbox"
                        className="h-4 w-4"
              ...
              {!isNewTask && activeTab === "activity" ? (
                <div className="flex min-h-0 flex-1 flex-col">
                  <h2 className="py-6 text-2xl font-semibold leading-tight tracking-tight text-foreground">
                    Activity
                  </h2>
                  ...
                  >
                    <div className="space-y-4 pb-6">
                        ...
                        <div className="rounded-md border border-border/60 bg-surface/40 p-4">
                          ...
                          <div className="divide-y divide-border/60">
                            {activity.map((entry) => (
                              ...
                              >
                                <p className="text-muted">{entry.type}</p>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-wrap gap-2 rounded-md border border-border/60 bg-surface/40 p-3">
                        ...
                        {comments.length > 0 ? (
                          comments.map((comment) => (
                            <div
                              ...
                              className="relative rounded-md border border-border/60 bg-card/40 p-4 shadow-sm"
                            >
                              {/* subtle left accent */}
                              <span className="absolute left-0 top-4 h-6 w-1 rounded-full bg-primary/70" />
                  ...
                  <div className="sticky bottom-0 border-t border-border/60 bg-card/90 px-4 py-3 shadow-[0_-8px_24px_rgba(0,0,0,0.06)] backdrop-blur supports-[backdrop-filter]:bg-card/80">
                    <div className="flex items-center gap-3">
                      <Input
                        ...
                        className="h-8 rounded-md border-border/70 bg-card/40 px-2.5 text-sm"
                        onKeyDown={(e) => {
                          if (e.key === "Enter") {
                            e.preventDefault();
                ...
                <div className="flex min-h-0 flex-1 flex-col">
                  ...
                  <div className="min-h-0 flex-1 overflow-y-auto pr-2">
                    <div className="space-y-3">
                      {files.map((file) => (
                        <div
                          key={file.id}
                          className="flex items-center justify-between rounded-md border border-border/60 bg-card/40 p-4 text-sm"
                        >
                  ...
                  <div className="mt-4 border-t border-border pt-4">
                    ...
                    <Button
                      type="button"
                      size="sm"
                      className="h-[23px] w-full rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] px-2 text-[12px] font-medium leading-[15px] text-[#FEFEFF] shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] hover:bg-[#6A76EB]"
            ...
            {!isNewTask ? (
              <div className="flex h-full w-[88px] shrink-0 flex-col border-l border-border/60 px-3 pt-4">
                {NavPill}
              </div>
            ) : null}
          </div>
