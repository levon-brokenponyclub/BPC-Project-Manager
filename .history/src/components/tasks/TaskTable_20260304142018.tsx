...
export function TaskTable({ tasks, onOpen, runningTaskId, onStartTimer, onStopTimer }: TaskTableProps): React.ReactElement {
  return (
    <Card className="overflow-hidden">
      <table className="w-full text-left text-sm">
        ...
        <tbody>
          ...
          {tasks.length === 0 ? (
            <tr>
              <td className="px-5 py-10 text-center text-sm text-muted" colSpan={4}>
                No tasks found.
              </td>
            </tr>
          ) : null}
