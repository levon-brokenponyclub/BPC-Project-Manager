...
export function NewTaskModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="flex max-h-[calc(100vh-3rem)] w-full max-w-[860px] flex-col overflow-hidden rounded-[6px] border border-border/70 bg-card shadow-card">
        ...
        <div className="grid gap-3 border-b border-border/70 px-4 py-3 md:grid-cols-2">
          <div className="space-y-1">
            <p className="text-[11px] font-medium uppercase tracking-wide text-muted">
              Workspace
            </p>
            <div className="flex h-9 items-center rounded-[5px] border border-border/70 bg-surface/50 px-3 text-sm text-foreground">
              {workspaceName}
            </div>
          </div>
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  {users.map((workspaceUser) => (
                    <option key={workspaceUser.user_id} value={workspaceUser.user_id}>
        ...
        <footer className="flex items-center justify-between border-t border-border/70 bg-surface/40 px-4 py-3">
          <input
            ref={fileInputRef}
            type="file"
            multiple
          ...
          <Button
            ...
            className="h-8 rounded-[5px] border-border/70 bg-card/60 px-3 text-xs font-medium text-foreground hover:bg-card"
          >
          ...
          <Button
            ...
            className="h-8 rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] px-3 text-xs font-semibold text-[#FEFEFF] shadow-none hover:bg-[#6A76EB]"
          >
