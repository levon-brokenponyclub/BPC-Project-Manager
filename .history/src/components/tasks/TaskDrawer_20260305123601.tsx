...
export function TaskDrawer({
  ...
  return (
    <div className="fixed inset-0 z-40 bg-black/20 backdrop-blur-sm">
      <aside className="fixed inset-y-0 right-0 w-full max-w-xl overflow-y-auto border-l border-border bg-card px-6 py-6 shadow-lift animate-in slide-in-from-right relative">
