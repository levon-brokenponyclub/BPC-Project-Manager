      ...
      <div className="flex max-h-[calc(100vh-3rem)] w-full max-w-[880px] flex-col overflow-hidden rounded-[4px] border border-[#292B38] bg-[#191A22] shadow-card">
        ...
        <footer className="flex items-center justify-between border-t border-[#25262B] bg-[#15161D] px-5 py-4">
          ...
          <Button
            ...
            className="h-10 rounded-[5px] border border-[#313339] bg-[#15161D] px-4 text-[13px] font-medium text-white hover:bg-[#1C1E26]"
          >
          ...
          <Button
            ...
            className="h-10 rounded-[5px] border border-[#6C77E5] bg-[#5E69D1] px-4 text-[13px] font-semibold text-white hover:bg-[#6A76EB]"
          >
