...
function UserAvatar({ email }: { email: string | null }) {
  ...
  return (
    <div
      className="flex h-7 w-7 items-center justify-center rounded-full bg-stone-200 text-xs font-medium text-stone-700 hover:bg-stone-300 transition-colors cursor-default"
      title={email}
    >
      {initial}
    </div>
