...
export function ProjectStatusStrip({
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-5 gap-y-2 rounded-lg border border-[#292B38] bg-[#191A22] px-5 py-3">
      {/* Name */}
...
export function OverviewMetricCard({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-2 rounded-lg border border-[#292B38] bg-[#191A22] p-4",
        onClick
          ? "cursor-pointer transition-colors hover:border-[#292B38]/80 hover:bg-[#15161D]"
          : "",
      )}
    >
      {/* Header row */}
...
export function PhaseBoardCard({
  ...
  return (
    <div className="rounded-lg border border-[#292B38] bg-[#191A22] p-5">
      {/* Header */}
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  phase.onClick && "cursor-pointer hover:bg-[#15161D]",
                )}
              >
...
export function OverviewListCard({
  ...
  return (
    <div className="flex flex-col rounded-lg border border-[#292B38] bg-[#191A22]">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#292B38] px-4 py-3">
        <p className="text-[11px] font-semibold uppercase tracking-[0.06em] text-muted">
          {title}
        </p>
        {badge != null ? (
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  item.onClick
                    ? "cursor-pointer transition-colors hover:bg-[#15161D]"
                    : "",
                )}
              >
                {Icon ? (
