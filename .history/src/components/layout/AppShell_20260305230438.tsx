...
export function AppShell(): React.ReactElement {
  ...
  return (
    <div>
      ...
      >
        <aside className="surface flex flex-col rounded-2xl px-2 py-4 shadow-card transition-[width] duration-200 ease-out md:sticky md:top-6 md:h-[calc(100vh-3rem)] md:px-3">
          ...
          <nav className="flex-1 space-y-1.5">
            ...
            {availableWorkspaces.length > 1 && !sidebarCollapsed ? (
              <div className="mt-3 rounded-xl border border-border/20 bg-surface/40 p-3">
          ...
          <div className="mt-4 border-t border-border/70 pt-3">
            <div className="relative" ref={profileMenuRef}>
              ...
              {profileMenuOpen ? (
                <div
                  className={`surface absolute z-30 mt-2 w-56 overflow-hidden rounded-xl border border-border/20 py-1 shadow-card ${
        ...
        <div className="min-w-0 space-y-4 md:space-y-6">
          <header className="surface sticky top-4 z-20 rounded-2xl px-4 py-3 shadow-card md:top-6">
            {isDemoMode ? (
              <div className="mb-3 flex w-full items-center justify-between rounded-xl border border-border/20 bg-surface/40 px-3 py-2 text-xs text-foreground">
            ...
            <div
              className={`mt-3 h-1 overflow-hidden rounded-full bg-border/25 transition-opacity ${
