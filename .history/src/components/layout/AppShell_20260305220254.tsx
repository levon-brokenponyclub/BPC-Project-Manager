            ...
            <div className="w-full flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="ml-auto flex flex-wrap items-center gap-3">
                ...
                <div className="relative" ref={profileMenuRef}>
                  <button
                    className="flex items-center gap-2 rounded-xl px-3 py-2 hover:bg-surface/60 transition-colors"
                  ...
                  {profileMenuOpen ? (
                    <div className="surface absolute right-0 z-30 mt-2 w-56 overflow-hidden rounded-xl border border-border py-1 shadow-card">
                      <button
                        className="w-full px-4 py-2 text-left text-sm text-foreground hover:bg-surface/60 transition-colors"
                        onClick={() => {
                          setProfileMenuOpen(false);
