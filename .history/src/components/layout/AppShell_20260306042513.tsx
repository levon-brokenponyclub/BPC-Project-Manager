                ...
                <div className="flex items-center justify-between border-b border-border/60 px-4 py-2.5">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      variant="secondary"
                      size="sm"
                      className="focus-ring inline-flex h-[23px] min-w-[72px] items-center gap-1 rounded-[5px] border border-border/70 bg-card/40 px-[6px] text-[12px] font-normal leading-[15px] text-foreground shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] transition-colors hover:bg-card/70"
                      onClick={handleDeleteActive}
                      disabled={!activeNotification || deleteMutation.isPending}
                    >
                      <Trash2 className="h-[14px] w-[14px] text-muted" />
                      Delete notification
                    </Button>
                    <Button
                      variant="secondary"
                    ...
                    >
                      <Clock3 className="h-[14px] w-[14px] text-muted" />
                      Snooze
                    </Button>
                    <Button
                      variant="secondary"
                      ...
                      disabled={!activeNotification}
                    >
                      <BellOff className="h-[14px] w-[14px] text-muted" />
                      Unsubscribe
                    </Button>
                  </div>
                </div>
