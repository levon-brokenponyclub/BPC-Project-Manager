...
const navItems = [
  { key: "dashboard", label: "Dashboard", icon: LayoutGrid, path: "dashboard", adminOnly: false },
  { key: "clients", label: "Clients", icon: Users, path: "clients", adminOnly: true },
  { key: "tasks", label: "Tasks", icon: ListTodo, path: "tasks", adminOnly: false },
  { key: "time", label: "Time", icon: Timer, path: "time", adminOnly: false },
  { key: "reports", label: "Reports", icon: ReceiptText, path: "reports", adminOnly: false },
  { key: "settings", label: "Settings", icon: Settings, path: "settings", adminOnly: false },
] as const;
