                ...
                <div className="flex items-center justify-between border-b border-border/60 px-4 py-2.5">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      variant="secondary"
                      size="sm"
                      className="h-[23px] min-w-[72px] gap-1 rounded-[5px] border border-[#2A2C31] bg-[#1D1F24] px-[6px] text-[12px] font-normal leading-[15px] text-[#E3E4E6] shadow-[0px_4px_4px_-1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.1)] hover:bg-[#22242A]"
                      onClick={handleDeleteActive}
                      disabled={!activeNotification || deleteMutation.isPending}
                    >
                      <Trash2 className="h-[14px] w-[14px] text-[#959699]" />
                      Delete notification
                    </Button>
                    <Button
                      variant="secondary"
                    ...
                    >
                      <Clock3 className="h-[14px] w-[14px] text-[#959699]" />
                      Snooze
                    </Button>
                    <Button
                      variant="secondary"
                      ...
                      disabled={!activeNotification}
                    >
                      <BellOff className="h-[14px] w-[14px] text-[#959699]" />
                      Unsubscribe
                    </Button>
                  </div>
                </div>
