...
export default function AppShell({ children }: AppShellProps): React.ReactElement {
  ...
  return (
    <div className="app-shell transition-[grid-template-columns] duration-200 ease-out" style={shellStyle}>
      <aside
      ...
      >
        <div className="sidebar-top">
          ...
          >
            ...
            {!collapsed ? (
              <span className="text-[13px] font-semibold leading-4 text-sidebar-foreground">Workspace</span>
            ) : null}
          </button>
