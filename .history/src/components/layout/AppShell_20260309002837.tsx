              ...
              <div className="grid min-h-0 grid-rows-[auto_minmax(0,1fr)] md:col-span-2 md:grid-cols-[minmax(0,1fr)_260px]">
                ...
                <header className="flex items-center justify-between gap-3 border-b border-[#222330] bg-[#191A22] px-5 py-[11px] md:col-span-2">
                  ...
                  <div className="flex shrink-0 items-center gap-1.5">
                    <button
                      type="button"
                      className="focus-ring inline-flex h-7 items-center gap-1.5 rounded-[5px] border border-[#2A2C38] bg-[#1F2030] px-2.5 text-[12px] font-medium text-[#8B8C9E] transition-colors hover:bg-[#252636] hover:text-white disabled:pointer-events-none disabled:opacity-40"
                    ...
                    renderInboxMessage(activeNotification).route ? (
                      <button
                        type="button"
                        className="focus-ring inline-flex h-7 items-center gap-1.5 rounded-[5px] bg-primary px-3 text-[12px] font-medium text-white transition-opacity hover:opacity-90"
                        onClick={() => {
                          const route =
                            renderInboxMessage(activeNotification).route;
                          if (!route) return;
                ...
                <div className="flex min-h-0 flex-col overflow-y-auto border-r border-[#222330]">
                  {activeNotification ? (
                    (() => {
                      ...
                      const changeMatch = message.subtitle?.match(
                        /^(.+?)\s*--\s*(.+)$/,
                      );
