...
const workspaceItems = [
  ...
  { label: "My issues" },
  { label: "Projects" },
] satisfies ReadonlyArray<WorkspaceItem>;
          ...
          <div className="space-y-1">
            {personalItems.map((item) => (
              <button
                key={item}
                type="button"
                className="focus-ring nav-item w-full"
              >
                <svg
                  viewBox="0 0 16 16"
                  className="h-4 w-4 shrink-0 text-muted"
        ...
        <header className="header">
          ...
          <div className="header-actions">
            ...
            <div className="inline-flex items-center rounded-md border border-border/40 bg-card/40 p-0.5">
              <button
                type="button"
                className="focus-ring rounded px-2 py-1 text-xs font-medium text-muted transition-colors hover:text-foreground"
              >
                Dark
              </button>
              <button
                type="button"
                className="focus-ring rounded bg-card/60 px-2 py-1 text-xs font-medium text-foreground"
              >
                Light
              </button>
              <button
