...
return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      ...
      >
        <aside className="surface flex flex-col rounded-2xl px-2 py-4 shadow-card transition-[width] duration-200 ease-out md:min-h-[86vh] md:px-3">
        ...
        <div className="space-y-4 md:space-y-6">
          <header className="surface rounded-2xl px-4 py-3 shadow-card">
            {isDemoMode ? (
