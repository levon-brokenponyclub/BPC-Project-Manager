...
export function AppShell(): React.ReactElement {
  ...
  return (
    <div className="min-h-screen bg-background p-3 md:p-4">
      <div
        className="mx-auto grid max-w-[1400px] grid-cols-1 gap-3 transition-[grid-template-columns] duration-200 ease-out md:gap-4 md:grid-cols-[var(--sidebar-w)_1fr]"
        style={sidebarGridStyle}
      >
        <aside className="surface flex flex-col rounded-xl border border-border/30 px-2 py-4 transition-[width] duration-200 ease-out md:min-h-[86vh] md:px-3">
          ...
          <div className="mt-4 border-t border-border/70 pt-3">
            <div className="relative" ref={profileMenuRef}>
              ...
              {profileMenuOpen ? (
                <div
                  className={`surface absolute z-30 mt-2 w-56 overflow-hidden rounded-xl border border-border/30 py-1 shadow-sm ${
        ...
        <div className="space-y-4 md:space-y-6">
          <header className="surface rounded-xl border border-border/30 px-4 py-3">
            {isDemoMode ? (
