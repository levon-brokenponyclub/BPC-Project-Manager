...
const menuItemClass =
  "focus-ring flex min-h-[44px] w-full items-center gap-3 rounded-[5px] px-3 text-left text-[13px] font-medium leading-4 text-[#E3E4EA] transition-colors hover:bg-[#1D1F24]";

const sectionLabelClass =
  "px-2 text-[11px] font-medium uppercase tracking-wide text-[#939496]";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Removed workspace summary block under logo */}

        <nav className="mt-1 flex flex-1 flex-col gap-2">
          <NavLink
            to="#"
            className={({ isActive }) =>
              cn(menuItemClass, isActive && "bg-[#1D1F24]", "justify-between")
            }
          >
            ...
            <span className="inline-flex h-8 min-w-8 items-center justify-center rounded-[5px] bg-[#191A22] px-2 text-[13px] font-medium leading-4 text-white">
          ...
          <NavLink
            to="#"
            className={({ isActive }) =>
              cn(menuItemClass, isActive && "bg-[#1D1F24]")
            }
          >
              ...
              <div key={workspace.id} className="flex flex-col">
                ...
                >
                  <span className="flex min-w-0 items-center gap-3">
                    <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center rounded-[4px] bg-[#5D85FF]" />
                    <span className="truncate">{workspace.name}</span>
                  </span>
                  <ChevronDown
                    className={cn(
                      "h-3.5 w-3.5 shrink-0 text-[#959699] transition-transform",
                      expanded && "rotate-180",
                    )}
                  />
                </button>
                {expanded ? (
                  <div className="ml-7 flex flex-col gap-1 border-l border-[#25262B] pl-3">
                    <NavLink
                      to={`/w/${workspace.id}/tasks`}
                      className={({ isActive }) =>
                        cn(
                          "focus-ring flex min-h-[36px] items-center rounded-[4px] px-2 text-[13px] font-medium leading-4 text-[#E3E4EA] transition-colors hover:bg-[#1D1F24]",
                          isActive && "bg-[#1D1F24]",
                        )
                      }
                    >
        ...
        <div className="mt-auto space-y-2 pt-3">
          ...
          >
            ...
            {!collapsed ? (
              <span className="text-[13px] font-medium leading-4 text-[#959699]">
                Profile
              </span>
            ) : null}
          </button>
