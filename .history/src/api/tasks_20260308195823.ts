...
export async function createTask(
  ...
  // Enforce that subtasks belong to the same workspace as their parent.
  if (input.parent_task_id) {
    ...
    if (parentTask.workspace_id !== workspaceId) {
      throw new Error("Subtask must belong to the same workspace as parent");
    }
  }
